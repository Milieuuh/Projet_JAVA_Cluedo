...
//CORRESPOND A LA FENETRE POUR ACCUSER
public class FenetreAccusation extends Parent {

    private Automate automate;
    private FenetreJeu fenetreJeu;

    public FenetreAccusation(Automate automate, Stage fenetre, FenetreJeu fenetreJeu) {
        ...
        //////////////////////////////////////LABEL TITRE
        Button accuse = new Button("J'ACCUSE");
        accuse.setLayoutY(10);
        accuse.setLayoutX(10);
        accuse.setFont(Font.font("Helvetica", FontWeight.EXTRA_BOLD, 28));
        accuse.setTextFill(Color.WHITE);
        accuse.setBackground(new Background(new BackgroundFill(Color.web("#6d071a"), null, null)));
        accuse.setBorder(new Border(new BorderStroke(Color.BLACK, BorderStrokeStyle.SOLID, null, null)));
        accuse.setPrefSize(625, 50);
        ...
        Button bt_ok = new Button("ACCUSER");
        ...
        bt_ok.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
              fenetreJeu.validerAccusation((String) CB_armes.getSelectionModel().getSelectedItem(), (String) CB_suspect.getSelectionModel().getSelectedItem());
              fenetre.close();
            }
        });
